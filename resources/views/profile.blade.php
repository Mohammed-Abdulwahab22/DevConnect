            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="rounded-[20px] p-6 bg-[#310D84]" style="box-shadow:-6px 3px 20px 4px #0000007d">
                    ...
                    <p class="text-gray-200 mb-4">
                        Just deployed a new feature on DevConnect! The performance boost is real. Excited to see how
                        users react. #FrontendDev #DevConnect
                    </p>
                ...
                <div class="rounded-[20px] p-6 bg-[#310D84]" style="box-shadow:-6px 3px 20px 4px #0000007d">
                    ...
                    <p class="text-gray-200 mb-4">
                        Attended an amazing virtual conference on AI ethics today. So much to learn and apply to our
                        work. #AI #Ethics #FutureTech
                    </p>
                    <div class="flex justify-between items-center text-gray-400 text-sm">
                        <div class="flex space-x-4">
                            <span class="flex items-center cursor-pointer hover:text-[#228CE0] transition duration-300">
